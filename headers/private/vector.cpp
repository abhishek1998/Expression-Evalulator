...
template <typename ElemType>
inline int Vector<ElemType>::size() const  {
	return numUsed;
}
...
template <typename ElemType>
inline void Vector<ElemType>::checkRange(int index, const char *verb) const {
...
template <typename ElemType>
inline ElemType &Vector<ElemType>::operator[](int index) const {
